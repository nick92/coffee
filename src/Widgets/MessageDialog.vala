 ...
 */
public class Coffee.MessageDialog : Gtk.Dialog {
    /**
    ...
    construct {
        ...
        primary_label.get_style_context ().add_class ("h1");
        ...
        message_grid.margin_top = 20;
        message_grid.margin_start = message_grid.margin_end = 20;
